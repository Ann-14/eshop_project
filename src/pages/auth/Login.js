    ...
    <>
      ...
      <div className="flex">
        <div className="my-auto mx-auto  flex flex-col justify-center   ">
          ...
          <div className="my-5">
            <button
              className="w-full text-center py-3 my-3 border flex space-x-2 items-center justify-center border-slate-200 rounded-lg  hover:border-yellow-500 hover:shadow transition duration-150"
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col space-y-5">
              ...
              <div className="flex gap-4">
                <label htmlFor="remember" className="">
                  <input
                    type="checkbox"
                    id="remember"
                    className="w-4 h-4 border-slate-200 focus:bg-indigo-600 mr-2"
                  />
                  Remember me
                </label>
              ...
              <button
                className="btn btn-primary mx-auto items-center justify-center w-full"
                disabled={loading}
                type="submit"
              >
                <svg
              ...
              <p className="text-center">
                ...
                <Link
                  to="/signup"
                  className="underline mt-24 hover:text-primary"
                >
                  Sign up!
                </Link>
              </p>
