  ...
  return (
    <main>
      ...
      <div className="flex h-screen ">
        <div className="lg:hidden relative overflow-hidden flex justify-center rounded-md items-center w-full mt-10 mb-24  ">
          ...
          <div className="absolute w-full text-lg flex flex-col justify-center gap-8">
            ...
            <ReactTyped
              ...
              smartBackspace
            />
            <p className="mt-2 mx-auto text-lg font-medium max-w-sm ">
              {" "}
              Need photos taken? Purchase one of our packages and consider it
              done
            </p>
        ...
        <div className="hidden lg:flex lg:items-center lg:justify-center text-center lg:text-left lg:w-1/2 md:bg-transparent  ">
          <div className="flex flex-col gap-4">
            <h2 className="text-5xl font-normal uppercase ">
              {" "}
              BCN <span className="text-primary">Photo</span>studio
            </h2>
            <ReactTyped
              ...
              smartBackspace
            />
            <p className="mt-2 text-xl lg:max-w-md font-medium ">
              Need photos taken? Purchase one of our packages and consider it
              done.
            </p>
        ...
        <div
          className="lg:mt-36 xl:mt-8 lg:py-18 xl:pb-14 hidden lg:flex lg:justify-center md:w-1/2"
      ...
      <div className=" mx-auto px-6 lg:pt-28 lg:pb-28 mb-6 md:space-y-10 md:mt-24 mt-0 ">
        <h1 className="text-3xl lg:text-4xl font-semibold mb-4 uppercase">
          OUR PACKAGES
        </h1>
        <hr className="h-5"></hr>
        <div className="mt-8">
          <div className="mt-8 flex-1 lg:mx-12 lg:mt-0  ">
            <div className=" grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3 text-slate-200">
              <Link to="/productsPage">
                <div className="relative flex hover:opacity-80 opacity-100">
                  <figure>
                    <img
                      src={dogImg}
                      alt="Shoes"
              ...
              <Link to="/productsPage">
                <div className="relative flex hover:opacity-80 opacity-100">
                  ...
                  <div className="absolute">
                    <h2 className="card-title p-6 text-2xl">
            ...
            <div className="card-actions justify-end mt-10 mr-8 ">
              <Link to="/productsPage">
                <button className="btn btn-primary ">
                  See more<span className="mr-2"></span>
                  <lord-icon
